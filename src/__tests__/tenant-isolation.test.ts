...
const CASES: readonly Case[] = [
  ...
  {
    payloadKey: "note_folders",
    table: "sync_note_folders",
    column: "name",
    victimMarker: "enc-victim-folder",
    attackerMarker: "enc-attacker-folder",
    row: (uuid, updated_at, marker) => ({
      uuid,
      name: marker,
      parent_uuid: null,
  ...
  {
    payloadKey: "app_categories",
    table: "sync_app_categories",
    column: "app_name",
    victimMarker: "enc-victim-app",
    attackerMarker: "enc-attacker-app",
    row: (uuid, updated_at, marker) => ({
      uuid,
      app_name: marker,
      project: "enc-project",
